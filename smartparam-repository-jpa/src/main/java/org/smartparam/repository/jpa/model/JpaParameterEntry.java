...
/**
 * JPA data source implementation of {@link ParameterEntry}.
 *
...
public class JpaParameterEntry implements ParameterEntry, JpaModelObject {
     ...
     * @param value  wartosc wiersza
     */
    public JpaParameterEntry(String[] levels, String value) {
     ...
     */
    public JpaParameterEntry(String... levels) {
     ...
     */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_sp_parameter_entry")
    @SequenceGenerator(name = "seq_sp_parameter_entry", sequenceName = "seq_sp_parameter_entry")
    public int getId() {
        return id;
    }
