 ...
 * @author Adam Dubiel
 */
public class PicoParamSerializerConfig extends ComponentConfig implements ParamSerializerConfig {

    private SerializationConfig serializationConfig;

    public PicoParamSerializerConfig(SerializationConfig serializationConfig) {
