...
import org.smartparam.engine.model.functions.RhinoFunction;
...
public class RhinoFunctionInvoker implements FunctionInvoker<RhinoFunction> {
    ...
    private Object call(RhinoFunction f, Object... args) {
        try {
            ...
            throw new ParamException(
                    ErrorCode.FUNCTION_INVOKE_ERROR, e,
     ...
     * przy czym:
     * <ol>
     * <li>jesli funkcja ma podane argumenty (oddzielone przecinkiem) lub string pusty, to $args oznacza te argumenty
     * <li>jesli funkcja ma argumenty rowne null, to $args jest renderowane jako 'ctx'
     * </ol>
     * na przyklad:
     * <pre>
    ...
    /**
     * Liczba znakow, o ktore zostanie powiekszony rozmiar
     * StringBuildera podczas konstruowania pelnego ciala funkcji.
     */
    private static final int INITIAL_EXTENT = 256;

    /**
     * Parametr ustawiajacy sile optymalizacji podczas kompilacji
     * funkcji rhino do bytecode'u.
     */
    private static final int OPTIMIZATION_LEVEL = 9;

    /**
     * Tworzy wewnetrzna nazwe funkcji, ktora zostanie uzyta podczas kompilacji funkcji javascriptowej
     * reprezentowanej przez podana RhinoFunction. Nazwa funkcji bedzie unikalna pod warunkiem,
     * ze identyfikatory funkcji rhinowskich (f.getId()) sa unikalne.
     *
    ...
    /**
     * Zamienia rezultat zwrocony przez funkcje rhino na obiekt javowy,
     * jesli rezultat jest wrapperem.
     *
