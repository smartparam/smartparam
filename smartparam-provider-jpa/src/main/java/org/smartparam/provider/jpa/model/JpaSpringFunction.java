...
public class JpaSpringFunction extends JpaFunctionImpl implements SpringFunction {
     ...
     */
    public JpaSpringFunction(String beanName, String methodName) {
