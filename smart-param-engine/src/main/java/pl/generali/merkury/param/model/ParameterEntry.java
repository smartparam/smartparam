...
public class ParameterEntry implements ParamModelObject {
     ...
     */
    public ParameterEntry(String[] levels, String value, Function function) {
        setLevels(levels);
        this.value = value;
     ...
     * @param value  wartosc wiersza
     */
    public ParameterEntry(String[] levels, String value) {
     ...
     * @param function  funkcja wartosci
     */
    public ParameterEntry(String csvLevels, String value, Function function) {
     ...
     * @param value     wartosc wiersza
     */
    public ParameterEntry(String csvLevels, String value) {
     ...
     * @param function  funkcja wartosci
     */
    public ParameterEntry(String csvLevels, Function function) {
     ...
     */
    public ParameterEntry(String... levels) {
     ...
     */
    void setLevel(int k, String pattern) {
