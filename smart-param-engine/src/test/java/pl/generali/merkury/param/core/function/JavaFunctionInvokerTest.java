...
public class JavaFunctionInvokerTest {
    ...
    public void testLoadClass() {
        ...
        // wykonanie testu
        Class<?> clazz = inv.loadClass("pl.generali.merkury.param.core.function.JavaFunctionInvokerTest");
    ...
    public void testFindClass() {
        ...
        Class<?> clazz = inv.findClass("pl.generali.merkury.param.core.function.JavaFunctionInvokerTest");
        assertSame(this.getClass(), clazz);
    ...
    public void testDumpStatistics() {
        ...
        assertTrue(dump.contains("class pl.generali.merkury.param.core.function.JavaFunctionInvokerTest"));
        assertTrue(dump.contains("class pl.generali.merkury.param.util.EngineUtil"));
