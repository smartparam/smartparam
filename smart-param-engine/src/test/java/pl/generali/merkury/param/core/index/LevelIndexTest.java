...
import pl.generali.merkury.param.matchers.BetweenMatcher;
import pl.generali.merkury.param.matchers.EqMatcher;
...
public class LevelIndexTest {
    ...
    /**
     * Test konstruktora
     * {@link LevelIndex#LevelIndex(int, pl.generali.merkury.param.core.type.AbstractType<?>[], pl.generali.merkury.param.core.index.Matcher[])}.
     */
    @Test
    ...
    /**
     * Test konstruktora {@link LevelIndex#LevelIndex(pl.generali.merkury.param.core.type.AbstractType<?>[])}.
     */
    @Test
    ...
    /**
     * Test konstruktora {@link LevelIndex#LevelIndex(pl.generali.merkury.param.core.index.Matcher[])}.
     */
    @Test
