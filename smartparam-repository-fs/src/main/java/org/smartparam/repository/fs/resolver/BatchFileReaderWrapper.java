 ...
 */
public class BatchFileReaderWrapper implements BatchReaderWrapper {

    private Charset charset;

    private String filePath;

    public BatchFileReaderWrapper(String filePath, Charset charset) {
    ...
    public Reader initializeReader() throws ParamBatchLoadingException {
        return StreamReaderOpener.openReaderForFile(filePath, charset);
    }
}
